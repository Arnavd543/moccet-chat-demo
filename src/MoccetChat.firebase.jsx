...
const MoccetChatFirebase = () => {
  ...
  // console.log('[MoccetChat] Current state:', {
  //   activeChannelId,
  //   activeChannelName: activeChannel?.name || 'Not found',
  //   channelExists: !!activeChannel,
  //   messageCount: currentMessages.length,
  //   messages: currentMessages,
  //   allChannelMessages: Object.keys(messages).map(id => ({ channelId: id, count: messages[id]?.length || 0 })),
  //   totalChannels: channels.length,
  //   allChannels: channels.map(c => ({ id: c.id, name: c.name }))
  // });
            ...
            <div className="moccet-project-details">
              <div className="moccet-project-name">
                {(() => {
                  ...
                  // console.log('[MoccetChat] Rendering channel name:', {
                  //   activeChannelId,
                  //   foundChannel: !!activeChannel,
                  //   channelName
                  // });
                  return channelName;
                })()}
        ...
        >
          ...
          <div className="moccet-messages-container">
            {loading && currentMessages.length === 0 ? (
              ...
              <>
                {/* console.log('[MoccetChat] Rendering messages:', currentMessages.length) */}
                {currentMessages.filter(message => message.id).map((message) => {
                  ...
                  // console.log('[MoccetChat] Rendering message:', {
...
export default MoccetChatFirebase;